...
import { FootnotesProvider, Footnote, FootnoteRef, Footnotes, FootnoteReference } from 'react-a11y-footnotes';
...
First, initialize the pointers <Eq math='l,r' /> to the widest positions and return value <Eq math='area' />:
